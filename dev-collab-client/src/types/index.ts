...
type MakeCreateData<T> = Omit<T, OptionalFields> &
...
export type SnippetWithWorkspace = DrizzleSnippet & {
  workspace?: WorkspaceWithPin;
};
export type WorkItemWithWorkspace = DrizzleWorkItem & {
  workspace?: WorkspaceWithPin;
};
